...
Bus Fleet Management: Logic to load, display, and manage bus routes and prices.

Visual Booking Engine: The core interactive module that renders the 2D seat grid and processes user selection.

Data Persistence Layer: A system to save and retrieve booking records and bus states using file handling.
